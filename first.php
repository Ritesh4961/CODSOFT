...
<body>
    ...
    <header>
        <div class="logo">
            <a href="#"> The Coffee <span>Spot </span></a>
        </div>
    ...
    <div class="contact" id="contact">
        <div class="contact-box">
            <div class="contact-image">
                <img src="img/wp2352871-coffee-shop-wallpapers.jpg">
            </div>
        </div>
        <div class="contact-box">
            <div class="contact-body">
                ...
                <form   action="data.php" method="post" >
                    ...
                    <div class="form-content">
                        <input type="contact"  name="Feedback" required>
                        <span></span>
    ...
    <div class="footer">
        <div class="footer-box">
            <div class="social-media">
                ...
                <a href="https://www.instagram.com/insane_darkvibe?igsh=MXhobzdtZWxybm9pag=="><i class="fa-brands fa-instagram" aria-hidden="true"></i></a>
            ...
            <div class="brand">
                <label> The Coffee  <span>Spot</span></label>
            </div>
        </div>
    </div>
